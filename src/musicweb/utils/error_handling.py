...
class FileProcessingError(MusicWebError):
    ...
    def __init__(
        self, file_path: str, operation: str, original_error: Exception = None
    ):
...
class DataProcessingError(MusicWebError):
    ...
    def __init__(
        self, operation: str, data_type: str = None, original_error: Exception = None
    ):
        self.operation = operation
            ...
            try:
                ...
                if error_mapping and type(e) in error_mapping:
                    mapped_error = error_mapping[type(e)](
                        f"Error in {func.__name__}: {str(e)}", original_error=e
                    )
                    if log_error:
                        logger.error(
...
def safe_execute(
    func: Callable, *args, default_return=None, error_message: str = None, **kwargs
) -> Any:
    """
