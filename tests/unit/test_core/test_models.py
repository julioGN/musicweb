...
from musicweb.core.models import Library, Track, TrackNormalizer
...
class TestTrack:
    ...
    def test_track_creation(self):
        ...
        track = Track(
            title="Test Song", artist="Test Artist", album="Test Album", duration=180
        )
    ...
    def test_track_normalization(self):
        ...
        track = Track(
            title="Test Song (feat. Another Artist)", artist="Test Artist & Friends"
        )
